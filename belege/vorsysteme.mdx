...
Manche Mandanten arbeiten nicht direkt in DATEV Unternehmen Online, sondern in einem Vorsystem: Pleo für Kartenausgaben, Moss für Kreditkarten und Ausgabenmanagement, Lexware Office als Buchhaltungsvorbereitung oder SevDesk. Der Weg der Belege in Limetax ist bei allen ähnlich: **das Vorsystem exportiert die Belege nach DUO, Limetax holt sie aus DUO**. Der SmartLogin-Agent kann daher auch bei Vorsystem-Mandanten laufen, du musst nur einmal sicherstellen, dass die Kette Vorsystem → DUO steht.
